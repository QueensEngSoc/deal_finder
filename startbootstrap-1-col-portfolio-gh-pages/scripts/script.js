...
function addDealString (merchant, deal, logoSrc, smallDetails, majorDetails) {
	...
	picDiv.innerHTML = '<a href="#"> <img class="img-fluid rounded mb-3 mb-md-0" src=' + logoSrc + 'alt=""> </a>'

	// Details
	let detDiv = document.createElement("div");
	detDiv.classList.add("col-md-5");
	detDiv.innerHTML = '<div class="dNameButton"><h3>'+  merchant+ '</h3>' + '<a class="detailButton btn btn-primary" href="#">View Details</a> </div> <p><strong><em>' + deal + '</em></strong><br>' + smallDetails;
...
function addDealMap(details) {
	...
	picDiv.innerHTML = '<a href="#"> <img class="img-fluid rounded mb-3 mb-md-0" src=' + details.logoSrc + 'alt=""> </a>'

	// Details
	let detDiv = document.createElement("div");
	detDiv.classList.add("col-md-5");
	detDiv.innerHTML = '<div class="dNameButton"><h3>'+  details.merchant+ '</h3>' + '<a class="detailButton btn btn-primary" href="#">View Details</a> </div> <p><strong><em>' + details.deal + '</em></strong><br>' + details.smallDetails;
